...
function ApproveDCABudget(cc, year, cctype) { 
    ...
    var errorMsg = "";
    var chkcount = 0;
    var currentrowcount = $("#tblApprDCABudget1 tbody tr").length;
    $("#tblApprDCABudget1 tbody tr").each(function () {
        var currentRow = $(this);
        var check = currentRow.find("td").eq(2).find('input[type="checkbox"]').is(':checked');        
    ...
    if (chkcount > 0) {
        errorMsg += "<p style='margin-top:-5px!important;' >Please Verify</p > ";
        isValid = false;
    }
    if (appstatus == "Select") {
        errorMsg += "<p style='margin-top:-5px!important;'>Select Status</p>";
...
////            $.ajax({
////                type: "POST",
////                url: "/HR/GetSalaryHeadsForCategoryUpdate",
